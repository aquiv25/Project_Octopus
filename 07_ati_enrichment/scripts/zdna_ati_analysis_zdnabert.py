...
Z-DNA: Z-DNABERT predictions (GCF_001194135.2_ASM119413v2_zdna_thr025.bedgraph)

Usage: python3 zdna_ati_analysis_zdnabert.py
"""
...
ZDNA_FILE  = Path("/Users/dassagaripova/Downloads/GCF_001194135.2_ASM119413v2_zdna_thr025.bedgraph")
...
def load_zdna():
    ...
    chrom_sizes = {}
    with open(str(ZDNA_FILE), "rt") as f:
        for line in f:
...
def make_plot(all_results, all_perms):
    ...
    plt.suptitle("O. bimaculoides  |  Z-DNA × A-to-I editing enrichment",
                 fontsize=13, y=1.02)
    plt.tight_layout()
    out = SCRIPT_DIR / "zdnabert_ati_enrichment.png"
...
def main():
    print("=" * 60)
    print("Z-DNABERT / A-to-I editing enrichment  |  O. bimaculoides v2")
    print("=" * 60)
    ...
    out_tsv = SCRIPT_DIR / "zdnabert_ati_results.tsv"
